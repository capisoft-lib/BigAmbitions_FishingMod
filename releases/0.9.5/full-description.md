...
Turn Big Ambitions' city waters into a complete fishing activity. Click visible outdoor water, cast from your current position near the water and reel in the catch through a polished circular keyboard QTE.

[b]Features[/b]

[list]
[*][b]One-click fishing[/b] — stay within 10 horizontal metres of mapped water, then click water or point at it and press F to cast in place. Land and obstacle checks apply.
...
[*]Stand within 10 horizontal metres of mapped water. Left-click visible water, or point at it and press F.
[*]The character casts from the current position without walking.
...
[*]No separate Workshop dependency is required; Harmony is included.
[/list]
...
[b]Mod options[/b]
Enable QTE: on by default. Disable it to automatically retrieve biting fish with normal rewards.
Difficulty: 0.2 to 5.0 (default 1.0). Higher values shorten the response window. Settings are saved and apply to the next bite.
